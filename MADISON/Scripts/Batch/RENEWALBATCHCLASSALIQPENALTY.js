...
var maxSeconds = 600 * 1;							// number of seconds allowed for batch processing, usually < 5*60
...
var appTypeType = "Clerk"; //				//   app type to process {Rental License}
var appSubtype = "ClassABeerLiquor"	;  //			//   app subtype to process {NA}
var appCategory = "NA"; //				//   app category to process {NA}

var expStatus =  "About to Expire";			//   test for this expiration status
var newExpStatus = ""; //	"Expired"	//   update to this expiration status
var newAppStatus = ""; //	"Expired"	//   update the CAP to this status
var editWorkflowTask = "";//"License Status"// Open this task {License Status},        
var newWorkflowStatus = "";//"About to Expire""Expired"// // change to this status {Delinquent}
