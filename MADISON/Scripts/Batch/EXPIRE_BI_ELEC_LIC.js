...
|
/------------------------------------------------------------------------------------------------------*/
var fromDate = "06/29/2012"; //getParam("fromDate"); 
var toDate = "07/01/2012"; //getParam("toDate");
...
var appTypeType = "Building Inspection" //getParam("appTypeType");				//   app type to process {Rental License}
var appSubtype =  "Electrical" //getParam("appSubtype");				//   app subtype to process {NA}
...
var deactivateLicense = "Y"//getParam("deactivateLicense");			// deactivate the LP
