...
var appTypeType = "Building Inspection";				//   app type to process {Rental License}
var appSubtype = "Electrical";			//   app subtype to process {NA}
var appCategory = 	"*";			//   app category to process {NA}

var expStatus =  "Active"			//   test for this expiration status
var newExpStatus = "About to Expire";	//   update to this expiration status
...
var skipAppStatusArray = new Array(); //""//getParam("skipAppStatus").split(",")
skipAppStatusArray [0] = "Void";
skipAppStatusArray [1] = "Pending";
...
var deactivateLicense = "N";		// deactivate the LP
var lockParentLicense = "N";    // add this lock on the parent license

var workflowFlowCode = "LIC_GENERAL";// Flow code for above status {U}
var assessRenewalFee= "Y";              // Y or N fee codes come from b1Exp
