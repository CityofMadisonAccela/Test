...
|
/------------------------------------------------------------------------------------------------------*/
var fromDate = "04/12/2013"; //getParam("fromDate"); 
var toDate = "04/16/2013"; //getParam("toDate");
...
var appTypeType = "Vending"; //getParam("appTypeType");				//   app type to process {Rental License}
...
var newExpStatus = "About to Expire"; //getParam("newExpirationStatus")		//   update to this expiration status
var newAppStatus = "About to Expire"; //getParam("newApplicationStatus")		//   update the CAP to this status
var editWorkflowTask = "License Status"; //getParam("editWorkflowTask");// Open this task {License Status},        
var newWorkflowStatus = "About to Expire"; //"About to Expire"//getParam("newWorkflowStatus"); // change to this status {Delinquent}
...
function mainProcess()
	...
	aa.sendMail("noreply@cityofmadison.com", emailAddress, "jschneider@cityofmadison.com", "Batch Job - expireFireLicenses", "At start of mainProcess function.");
