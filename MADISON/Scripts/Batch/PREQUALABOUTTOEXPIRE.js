/*------------------------------------------------------------------------------------------------------/
| Program: PreQualAboutToExpire.js  Trigger: Batch
| Client: Madison
...
var emailSubject = "";
var emailBody = "";
var emailFrom = "japien@cityofmadison.com";
var capId;
var altId;
var appStatus;
...
function mainProcess() {
	...
	if (lpResult.getSuccess()) {
		...
		logDebug("The number of License Professionals: " + lps.length + br);
	} else {
	...
	for (lp in lps) {
		...
		if (cap) {
			...
			if (appStatus == "Active" || appStatus == "About to Expire") {
