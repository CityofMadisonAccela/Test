// THIS IS A ONE OFF, I, RIKI, SHALL DEVELOP AND STANDARDIZE SCRIPT TO USE LATER
...
var AInfo = new Array();
var strIssuedDate = "2013-4-10";
var courtdt1 = "01/08/2013";
var courtdt2 = "01/09/2013";
var strReinspection = "04/01/2013";
var currentrec = courtdt1;
var citationSeries = "B12";
var citationNo = 1183;
...
//Get the CAPS
BICAP = aa.set.getCAPSetMembersByPK("CL LIC DAILY"); //Here we are going to attempt to get the caps from the set
...
if (BICAP.getSuccess())
{
	...
	for(var iRecords=0; iRecords < BICAPs.length; iRecords++) 
	{
		...
		saveReport("Business License"); // Riki 4/11/13 : Added this because I want to save the report in the batch. You might need to modiy the SSRS report to not lock the tables
