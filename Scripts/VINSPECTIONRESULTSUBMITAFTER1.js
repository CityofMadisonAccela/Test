...
for (inspCount in inspIdArr)
	{
	var s_capResult = aa.cap.getCapID(s_id1[inspCount], s_id2[inspCount], s_id3[inspCount]);
	...
	inspResultDate = inspObj.getInspectionStatusDate().getMonth() + "/" + inspObj.getInspectionStatusDate().getDayOfMonth() + "/" + inspObj.getInspectionStatusDate().getYear();
        inspOccurredDate = inspObj.getInspectionDate().getMonth() + "/" + inspObj.getInspectionDate().getDayOfMonth() + "/" + inspObj.getInspectionDate().getYear();
	logDebug("inspOccurredDate = " + inspOccurredDate);
