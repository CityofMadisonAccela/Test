...
sendDebugEmail = true;
debugEmailAddress = "glabelle-brown@cityofmadison.com";
...
//aa.sendEmail("elamsupport@cityofmadison.com", "jmoyer@cityofmadison.com", "jmoyer@cityofmadison.com", "emailSubject", "emailText", "");
...
function getScriptText(vScriptName){
	...
	try {
		var emseScript = emseBiz.getMasterScript(servProvCode,vScriptName);
